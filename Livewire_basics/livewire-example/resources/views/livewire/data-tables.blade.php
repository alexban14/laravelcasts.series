        ...
        <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
            ...
            <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg mt-4">
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tr>
                        <th
                            class="w-4/12 px-6 py-3 text-left">
                            <div class="flex items-center">
                                ...
                                @if ($sortField !== 'name')
                                    <span></span>
                                @elseif ($sortAsc)
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-3 ml-2">
                        ...
                        <th
                            class="w-4/12 px-6 py-3 bg-gray-50 text-left text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider">
                            Status
                        </th>
