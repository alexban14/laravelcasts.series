                ...
                <div class="h-0 flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
                    ...
                    <nav class="mt-5 flex-1 px-2 bg-gray-800">
                        <x-desktop-nav-link route="dashboard">
                            <svg
                                class="mr-3 h-6 w-6 {{Request::routeIs('dashboard') ? 'text-gray-300' : 'text-gray-400'}} group-hover:text-gray-300 group-focus:text-gray-300 transition ease-in-out duration-150"
                                fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                      d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"/>
                            </svg>
                    ...
                    <div class="relative isolate flex items-center gap-x-6 overflow-hidden bg-gray-50 px-6 py-2.5 sm:px-3.5 sm:before:flex-1">
                        ...
                        <div class="flex flex-wrap items-center gap-x-4 gap-y-2">
                            <p class="text-sm leading-6 text-gray-900">
                                You are impersonating<strong class="font-semibold"> {{auth()->user()->name}}</strong><svg viewBox="0 0 2 2" class="mx-2 inline h-0.5 w-0.5 fill-current" aria-hidden="true"><circle cx="1" cy="1" r="1" /></svg>{{auth()->user()->email}}
                            </p>
                            <a href="{{route('impersonation.leave')}}" class="flex-none rounded-full bg-gray-900 px-3.5 py-1 text-sm font-semibold text-white shadow-sm hover:bg-gray-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-900">Leave Impersonation <span aria-hidden="true">&rarr;</span></a>
                        </div>
                    </div>
                @endif
